...
export default function TemplatePreview({ templateSlug, className = "" }: TemplatePreviewProps) {
  ...
  // Template 1: Bold restaurant-style design
  ...
  // Template 2: Clean modern design with all sections
  ...
  // Template 3: Insurance blue theme with complete sections
  if (templateSlug === "template-3") {
    return (
      <div className={`bg-white border rounded-lg overflow-hidden ${className}`} style={{ scrollBehavior: 'smooth' }}>
        ...
        <div id="about" className="px-6 py-16 bg-white">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-center text-blue-600">About John Smith</h2>
            <div className="grid grid-cols-2 gap-12 items-center">
              <div>
                <p className="text-gray-700 mb-6 leading-relaxed">
                  With over 15 years of experience in financial planning and risk management, John Smith specializes in protecting and growing your wealth through comprehensive insurance and investment strategies.
                </p>
                <p className="text-gray-700 mb-6 leading-relaxed">
                  His client-first approach ensures that every financial plan is tailored to your unique needs, providing peace of mind and long-term financial security.
                </p>
                <div className="grid grid-cols-2 gap-6 mt-8">
                  <div className="flex items-center">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-sm font-medium">500+ Protected Families</span>
                  </div>
                  <div className="flex items-center">
              ...
              <div className="bg-blue-50 p-8 rounded-2xl">
                ...
                <p className="text-gray-700 mb-6">
                  To provide comprehensive financial protection and growth strategies that secure your family's future and give you confidence in your financial decisions.
                </p>
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-green-500 mr-3 mt-1" />
                    <span className="text-sm">Comprehensive risk assessment</span>
                  </div>
                  <div className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-green-500 mr-3 mt-1" />
                    <span className="text-sm">Long-term wealth building</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div id="services" className="px-6 py-16 bg-blue-50">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-center text-blue-600">Our Services</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="p-6 bg-white border-t-4 border-blue-600">
                <Shield className="w-10 h-10 text-blue-600 mb-4" />
                <h3 className="text-lg font-semibold mb-3">Life Insurance</h3>
                <p className="text-gray-600 text-sm">
                  Protect your family's financial future with comprehensive life insurance policies tailored to your needs.
                </p>
              </Card>
              <Card className="p-6 bg-white border-t-4 border-blue-600">
                ...
                <p className="text-gray-600 text-sm">
                  Build wealth through strategic investment planning and portfolio management services.
                </p>
              </Card>
              <Card className="p-6 bg-white border-t-4 border-blue-600">
                <Home className="w-10 h-10 text-blue-600 mb-4" />
                <h3 className="text-lg font-semibold mb-3">Property Insurance</h3>
                <p className="text-gray-600 text-sm">
                  Safeguard your home and assets with comprehensive property and casualty insurance coverage.
                </p>
              </Card>
            </div>
          </div>
        ...
        <div id="contact" className="px-6 py-16 bg-gray-800 text-white">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-2 gap-12">
              <div>
                <h2 className="text-3xl font-bold mb-8">Get Your Free Consultation</h2>
                <div className="space-y-6">
                  <div className="flex items-center">
                ...
                <div className="mt-8 p-4 bg-blue-900 rounded-lg">
                  ...
                  <ul className="text-sm space-y-1">
                    <li>• Complete financial needs analysis</li>
