    ...
    <div className={`bg-white ${className}`}>
      ...
      <section className="overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[70vh]">
          ...
          <div className="bg-red-700 flex items-center justify-center lg:justify-end py-8 lg:py-0 px-4 sm:px-6 lg:px-8">
            <div className="max-w-lg text-center lg:text-left w-full lg:mr-6">
