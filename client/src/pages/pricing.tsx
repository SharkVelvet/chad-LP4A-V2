...
import { FileText, Check, Menu, X } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-sm">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-gray-900 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Completely Custom from Design to Development</span>
                </div>
                <div className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-gray-900 flex-shrink-0 mt-0.5" />
            ...
            <div className="rounded-3xl p-8 shadow-sm" style={{ backgroundColor: '#E5E1F5' }}>
              ...
              <div className="mb-8">
                <h2 className="text-3xl font-bold text-gray-900"><em>YES</em>. We do that !</h2>
              </div>
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-gray-900 flex-shrink-0 mt-0.5" />
